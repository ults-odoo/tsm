...
class ReportCashBook(models.AbstractModel):
    ...
    def _get_account_move_entry(self, accounts, init_balance, sortby, display_account):
        ...
        # Get operating unit id from context
        ...
        if init_balance:
            ...
            if operating_unit_id:
                init_wheres.append("m.operating_unit_id = %s")
                init_where_params += (operating_unit_id,)
            ...
            sql = ("""
                ...
                '' AS partner_name, acc.name AS account_name,
        ...
        # Prepare SQL query based on selected parameters from the wizard
        ...
        # Add operating unit filter if provided
        if operating_unit_id:
            wheres.append("m.operating_unit_id = %s")
            where_params += (operating_unit_id,)
        ...
        sql = ("""
            ...
            m.id AS mmove_id  -- Include move_id for clickable links
            FROM account_move_line l
            ...
            l.ref, l.name, m.name, acc.name, c.symbol, p.name, m.id
